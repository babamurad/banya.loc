<div wire:ignore.self class="modal fade" id="EditEmployeeModal" role="viewDialog" aria-hidden="true">
    <div class="modal-dialog card" style="max-width: 50%;">
        <div class="modal-content">
            ...
            <div class="modal-footer justify-content-between">
                ...
                <button type="submit" class="btn btn-primary" wire:click="update"> {{__('Save changes')}} </button>
            </div>
            <!-- /modal-content  -->
        </div>
        <!-- /.modal-content -->

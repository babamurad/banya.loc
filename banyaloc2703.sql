...
) ENGINE=InnoDB AUTO_INCREMENT=100 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AVG_ROW_LENGTH=16384 ROW_FORMAT=DYNAMIC;

-- Дамп данных таблицы banya.orders: ~54 rows (приблизительно)
DELETE FROM `orders`;
INSERT INTO `orders` (`id`, `num`, `data`, `employes_id`, `clients_id`, `department_id`, `user_id`, `start`, `end`, `sum`, `desc`, `created_at`, `updated_at`) VALUES
	...
	(92, '90', '2024-03-24', 3, 2, 1, NULL, '08:00:00', '09:30:00', 0.00, NULL, '2024-03-24 04:30:44', '2024-03-24 04:36:10'),
	(93, '93', '2024-03-24', 3, 2, 1, NULL, NULL, NULL, 0.00, NULL, '2024-03-26 02:34:19', '2024-03-26 02:34:19'),
	(95, '94', '2024-03-24', 3, 2, 2, NULL, NULL, NULL, 0.00, NULL, '2024-03-26 03:46:24', '2024-03-26 03:46:24'),
	(96, '96', '2024-03-26', 3, 2, 1, NULL, NULL, NULL, 0.00, NULL, '2024-03-26 03:46:44', '2024-03-26 03:46:44'),
	(97, '97', '2024-03-24', 3, 133, 2, 22, '08:00:00', '10:00:00', 250.00, NULL, '2024-03-26 03:47:10', '2024-03-26 03:47:34'),
	(98, '98', '2024-03-24', 3, 2, 2, NULL, NULL, NULL, 0.00, NULL, '2024-03-26 03:49:48', '2024-03-26 03:49:48'),
	(99, '99', '2024-03-24', 3, 133, 2, 22, '12:00:00', '13:30:00', 187.50, NULL, '2024-03-26 03:50:58', '2024-03-26 03:51:14');
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AVG_ROW_LENGTH=4096 ROW_FORMAT=DYNAMIC;

-- Дамп данных таблицы banya.order_details: ~5 rows (приблизительно)
...
INSERT INTO `order_details` (`id`, `name`, `num`, `order_id`, `jobtitle_id`, `employes_id`, `start`, `end`, `qty`, `price`, `sum`, `created_at`, `updated_at`) VALUES
	...
	(35, 'Fatima', 90, 87, 10, 4, NULL, NULL, 1.00, 575.00, NULL, '2024-03-24 02:43:46', '2024-03-24 02:43:46'),
	(36, 'Massazh', 90, 87, 15, 4, NULL, NULL, 2.00, 125.00, NULL, '2024-03-24 02:43:58', '2024-03-24 02:43:58'),
	(45, 'Sauna', 94, 87, 2, 3, NULL, NULL, 1.00, 62.00, 62.00, '2024-03-26 03:45:15', '2024-03-26 03:45:15'),
	(46, 'Banya', 97, 87, 1, 4, NULL, NULL, 1.00, 154.00, 154.00, '2024-03-26 03:47:31', '2024-03-26 03:47:31');
...
INSERT INTO `time_tb` (`id`, `data`, `time`, `order_time`, `order_id`, `busy`) VALUES
	...
	(33, '2024-01-07', '08:00:00', '08:00:00', 92, 1),
	(34, '2024-01-07', '08:15:00', '08:15:00', 92, 1),
	(35, '2024-01-07', '08:30:00', '08:30:00', 92, 1),
	(36, '2024-01-07', '08:45:00', '08:45:00', 92, 1),
	(37, '2024-01-07', '09:00:00', '09:00:00', 92, 1),
	(38, '2024-01-07', '09:15:00', '09:15:00', 92, 1),
	(39, '2024-01-07', '09:30:00', '09:30:00', 92, 1),
